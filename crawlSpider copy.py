...
from testScrapeProject import settings
...
class ScrapySpider(CrawlSpider):
    ...
    allowed_domains = settings.EXTRACTING_URLS
    
    # Starting URLs for each domain
    start_urls = [f'https://www.{domain}' for domain in allowed_domains]
